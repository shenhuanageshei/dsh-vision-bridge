...
> 交接时间:2026-09-07。给接手模型:先读完本文件再动手;仓库内 docs/de
> 〔2026-09-09 时效戳:本文件为 9/7 快照——测试计数/版本已过时(现为 296+ 用例、§11 卡片 v2 已交付、9/8-9/9 补丁冲掉事故催生 §12 启动自愈);最新权威 = docs/design.md §11/§12 + docs/VERIFY.md §9/§10。先读 design 后再读本文件。〕

sign.md 是权威设计(含全部运行时事实的文件:行号证据),docs/VERIFY.md 是验收清单。
