...
/**
 * Build the cache configuration fingerprint (design §5.5): endpoint + model +
 * language + output format + engine prompt/schema version. Any change produces
 * a new fingerprint, so persisted notes miss naturally and age out via LRU.
 */
